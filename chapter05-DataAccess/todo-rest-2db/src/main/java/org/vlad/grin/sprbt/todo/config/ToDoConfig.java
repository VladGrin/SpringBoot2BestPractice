package org.vlad.grin.sprbt.todo.config;
...
import org.vlad.grin.sprbt.todo.repository.ToDoRepository;
...
public class ToDoConfig {
    ...
    public DataSource todoDataSource() {
        return todoDataSourceProperties().initializeDataSourceBuilder()
    ...
    public LocalContainerEntityManagerFactoryBean todoEntityManager(
        ...
        EntityManagerFactoryBuilder builder = createEntityManagerFactoryBuilder(todoJpaProperties);
        return builder
