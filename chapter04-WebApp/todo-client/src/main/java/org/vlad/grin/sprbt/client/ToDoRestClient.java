...
import org.vlad.grin.sprbt.client.domain.ToDo;
import org.vlad.grin.sprbt.client.error.ToDoErrorHandler;
...
public class ToDoRestClient {
    ...
    public ToDo setCompleted(String id) throws URISyntaxException {
        Map<String, String> params = new HashMap<>();
        params.put("id", id);
        restTemplate.postForObject(properties.getUrl() + properties.getBasePath() + "/{id}", null, ResponseEntity.class, params);
