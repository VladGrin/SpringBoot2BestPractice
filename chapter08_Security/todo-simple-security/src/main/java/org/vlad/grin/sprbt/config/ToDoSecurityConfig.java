...
import org.vlad.grin.sprbt.directory.Person;
...
public class ToDoSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.inMemoryAuthentication()
                ...
                .withUser("grin")
                .password(passwordEncoder().encode("sringboot2"))
                .roles("ADMIN","USER");
    }
...
public class ToDoSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final Logger log = LoggerFactory.getLogger(ToDoSecurityConfig.class);
